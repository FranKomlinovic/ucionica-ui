...
export class BackendService {
    ...
    endStay(userId: string, date: Date): Observable<IMessageResponse> {
        return this.http.post<IMessageResponse>(
            this.endStayUrl,
            new CreateStayModel(userId, date)
        );
    ...
    createPayment(payment: CreatePaymentModel): Observable<IMessageResponse> {
        return this.http.post<IMessageResponse>(this.paymentsUrl, payment);
    }

    getPaymentById(id: string): Observable<CreatePaymentModel> {
        return this.http.get<CreatePaymentModel>(this.paymentsUrl + '/' + id);
    }
}
